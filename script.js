...
const translations = {
  en: {
    ...
    "services.card.ocean.title": "Ocean Freight<br>(FCL &amp; LCL)",
    "services.card.ocean.p1": "We provide Full Container Load (FCL) and Less-Than-Container Load (LCL) ocean freight services through trusted ocean carriers. Whether importing or exporting, our team handles coordination, documentation, and route planning.",
    "services.card.ocean.p2": "<strong>Ideal for:</strong> commercial imports/exports, bulk shipments, long-distance international cargo.",
    "services.card.expedite.title": "Expedited Shipping",
    "services.card.expedite.p1": "Time-critical shipments delivered with maximum speed. Ideal for urgent freight, same-day moves, and fast cross-border deliveries.",
    "services.card.expedite.p2": "With true 24/7 availability, Magic Shipping is ready to move urgent shipments at any hour.",
    "services.card.hazmat.title": "Hazardous Materials (Haz-Mat)",
    "services.card.hazmat.p1": "Certified handling and safe transport for regulated hazardous goods. We ensure compliance with all government and carrier regulations.",
    "services.card.temp.title": "Temperature-Controlled Freight",
    "services.card.temp.p1": "Reliable cold-chain solutions for perishables, medical supplies, and temperature-sensitive cargo. We work with trusted temperature-controlled LTL and dedicated truckload providers to protect sensitive products throughout the entire journey.",
    "services.card.temp.p2": "Ask our team how we ensure your temperature requirements are monitored and met every time.",
    "services.card.rail.title": "Rail Freight",
    "services.card.rail.p1": "Eco-friendly long-distance shipping. Rail transportation is one of the most efficient ways to move bulk goods across Canada and the U.S. Magic Shipping provides reliable rail freight services for companies looking for lower cost, high-capacity transportation.",
    "services.card.rail.p2": "<strong>Ideal for:</strong> bulk shipments, large commercial goods, long-distance domestic cargo.",
    "services.card.consulting.title": "Logistics Consulting (3PL-Style Support)",
    "services.card.consulting.p1": "Expert guidance for businesses looking to simplify shipping. We advise companies on the best transport mode, routing, and cost-effective logistics strategies. Whether you ship occasionally or operate a growing business, we can support you as a 3PL-style logistics partner, optimizing your supply chain from end to end.",
    "services.card.warehousing.title": "Warehousing, Storage &amp; Distribution",
    "services.card.warehousing.p1": "Secure storage and seamless distribution support. We offer short-term and long-term warehousing options to support Canadian and international shippers. Perfect for businesses needing 3PL-style storage, inventory handling, or distribution support.",
    "services.card.warehousing.p2": "<strong>Ideal for:</strong> commercial storage, palletized goods, distribution support.",
    "services.card.whiteglove.title": "White Glove Delivery",
    "services.card.whiteglove.p1": "Premium handling for high-value, fragile, or sensitive items. Includes inside delivery, special care, and personalized coordination.",
    "services.card.customs.title": "Customs Clearance &amp; Documentation Support",
    "services.card.customs.p1": "Smooth cross-border shipping without delays. Our team assists with customs paperwork, duties/taxes guidance, waybills, clearance requirements, and documentation for international shipments &ndash; ensuring your cargo moves without interruptions.",
    "services.card.customs.p2": "<strong>Ideal for:</strong> international shipments, import/export requirements, cross-border compliance.",
    "services.card.insurance.title": "Cargo Insurance",
    "services.card.insurance.p1": "We offer cargo insurance options for all transport modes &ndash; air, ocean, rail, and trucking &ndash; giving customers peace of mind through enhanced shipment security.",
  ...
  fr: {
    ...
    "services.card.ltl.p2": "<strong>Idéal pour :</strong> marchandises palettisées, cargaison commerciale, expéditions régionales et longue distance.",

    "services.card.ocean.title": "Fret maritime<br>(FCL & LCL)",
    "services.card.ocean.p1": "Nous proposons des services de fret maritime FCL (conteneur complet) et LCL (groupage) via des transporteurs maritimes de confiance. Que ce soit pour l’importation ou l’exportation, notre équipe gère la coordination, la documentation et la planification des itinéraires.",
    "services.card.ocean.p2": "<strong>Idéal pour :</strong> importations/exportations commerciales, cargaisons en vrac, transport international longue distance.",

    "services.card.expedite.title": "Transport accéléré",
    "services.card.expedite.p1": "Envois critiques livrés avec une rapidité maximale. Idéal pour le fret urgent, les livraisons le jour même et les expéditions transfrontalières rapides.",
    "services.card.expedite.p2": "Grâce à une disponibilité réelle 24/7, Magic Shipping peut déplacer vos envois urgents à tout moment.",

    "services.card.hazmat.title": "Marchandises dangereuses (Haz-Mat)",
    "services.card.hazmat.p1": "Gestion certifiée et transport sécurisé des marchandises dangereuses réglementées. Nous assurons la conformité avec toutes les réglementations gouvernementales et transporteurs.",

    "services.card.temp.title": "Fret à température contrôlée",
    "services.card.temp.p1": "Solutions fiables de chaîne du froid pour les denrées périssables, produits médicaux et cargaisons sensibles à la température. Nous travaillons avec des transporteurs LTL à température contrôlée et des camions dédiés pour protéger vos produits tout au long du trajet.",
    "services.card.temp.p2": "Demandez-nous comment nous assurons un suivi précis et constant de vos exigences thermiques.",

    "services.card.rail.title": "Transport ferroviaire",
    "services.card.rail.p1": "Transport longue distance écologique. Le transport ferroviaire est l’une des méthodes les plus efficaces pour déplacer des marchandises en vrac au Canada et aux États-Unis. Magic Shipping offre des services ferroviaires fiables pour les entreprises recherchant une solution économique et à grande capacité.",
    "services.card.rail.p2": "<strong>Idéal pour :</strong> envois en vrac, marchandises commerciales lourdes, transport domestique longue distance.",

    "services.card.consulting.title": "Consultation logistique (support de type 3PL)",
    "services.card.consulting.p1": "Conseils d’experts pour simplifier vos opérations d’expédition. Nous aidons les entreprises à choisir le mode de transport, l’itinéraire et les stratégies logistiques les plus rentables. Que vous expédiiez occasionnellement ou gériez une entreprise en croissance, nous pouvons vous accompagner comme un partenaire logistique de type 3PL en optimisant votre chaîne d’approvisionnement de bout en bout.",

    "services.card.warehousing.title": "Entreposage, stockage et distribution",
    "services.card.warehousing.p1": "Stockage sécurisé et soutien complet à la distribution. Nous offrons des options d’entreposage à court et long terme pour les expéditeurs au Canada et à l’international. Parfait pour les entreprises ayant besoin de stockage 3PL, de gestion d’inventaire ou de soutien à la distribution.",
    "services.card.warehousing.p2": "<strong>Idéal pour :</strong> stockage commercial, marchandises palettisées, services de distribution.",

    "services.card.whiteglove.title": "Livraison White Glove",
    "services.card.whiteglove.p1": "Service premium pour les articles de grande valeur, fragiles ou sensibles. Comprend la livraison à l’intérieur, la manutention spéciale et une coordination personnalisée.",

    "services.card.customs.title": "Dédouanement et support documentaire",
    "services.card.customs.p1": "Expéditions transfrontalières sans retard. Notre équipe vous aide avec les documents douaniers, conseils sur les droits/taxes, lettres de transport, exigences de dédouanement et documentation pour les envois internationaux – garantissant un mouvement fluide de vos marchandises.",
    "services.card.customs.p2": "<strong>Idéal pour :</strong> expéditions internationales, exigences import/export, conformité transfrontalière.",

    "services.card.insurance.title": "Assurance cargo",
    "services.card.insurance.p1": "Nous proposons des options d’assurance cargo pour tous les modes de transport – aérien, maritime, ferroviaire et routier – offrant une tranquillité d’esprit grâce à une protection renforcée des expéditions.",
  ...
  es: {
    ...
    "services.card.ltl.p2": "<strong>Ideal para:</strong> carga paletizada, mercancía comercial, envíos regionales y de larga distancia.",

    "services.card.ocean.title": "Transporte marítimo<br>(FCL y LCL)",
    "services.card.ocean.p1": "Ofrecemos servicios marítimos FCL (contenedor completo) y LCL (consolidado) a través de navieras confiables. Ya sea importación o exportación, nuestro equipo gestiona la coordinación, documentación y planificación de rutas.",
    "services.card.ocean.p2": "<strong>Ideal para:</strong> importaciones/exportaciones comerciales, carga a granel, transporte internacional de larga distancia.",

    "services.card.expedite.title": "Transporte acelerado",
    "services.card.expedite.p1": "Envíos críticos entregados con la máxima rapidez. Ideal para carga urgente, entregas el mismo día y envíos transfronterizos rápidos.",
    "services.card.expedite.p2": "Con disponibilidad real 24/7, Magic Shipping puede mover envíos urgentes a cualquier hora.",

    "services.card.hazmat.title": "Materiales peligrosos (Haz-Mat)",
    "services.card.hazmat.p1": "Manejo certificado y transporte seguro de mercancías peligrosas reguladas. Garantizamos cumplimiento con todas las normativas gubernamentales y de transportistas.",

    "services.card.temp.title": "Carga con control de temperatura",
    "services.card.temp.p1": "Soluciones confiables de cadena de frío para productos perecederos, suministros médicos y mercancía sensible a la temperatura. Trabajamos con transportistas LTL refrigerados y camiones dedicados para proteger productos sensibles durante todo el recorrido.",
    "services.card.temp.p2": "Consulte cómo garantizamos el cumplimiento de sus requisitos de temperatura en cada envío.",

    "services.card.rail.title": "Transporte ferroviario",
    "services.card.rail.p1": "Envíos ecológicos de larga distancia. El transporte por ferrocarril es uno de los métodos más eficientes para mover carga a granel en Canadá y Estados Unidos. Magic Shipping ofrece servicios ferroviarios confiables para empresas que buscan una solución económica y de alta capacidad.",
    "services.card.rail.p2": "<strong>Ideal para:</strong> carga a granel, mercancía comercial pesada, envíos domésticos de larga distancia.",

    "services.card.consulting.title": "Consultoría logística (soporte tipo 3PL)",
    "services.card.consulting.p1": "Asesoría experta para empresas que buscan simplificar sus operaciones de envío. Ayudamos a elegir el modo de transporte, rutas y estrategias logísticas más rentables. Ya sea que envíe ocasionalmente o maneje un negocio en crecimiento, podemos apoyarlo como un socio logístico tipo 3PL optimizando su cadena de suministro de principio a fin.",

    "services.card.warehousing.title": "Almacenaje, almacenamiento y distribución",
    "services.card.warehousing.p1": "Almacenamiento seguro y soporte fluido de distribución. Ofrecemos opciones de almacenamiento a corto y largo plazo para clientes en Canadá y el extranjero. Perfecto para empresas que necesitan almacenamiento tipo 3PL, manejo de inventario o apoyo de distribución.",
    "services.card.warehousing.p2": "<strong>Ideal para:</strong> almacenamiento comercial, mercancía paletizada, soporte de distribución.",

    "services.card.whiteglove.title": "Servicio White Glove",
    "services.card.whiteglove.p1": "Manejo premium para artículos de alto valor, frágiles o sensibles. Incluye entrega dentro del domicilio, cuidado especial y coordinación personalizada.",

    "services.card.customs.title": "Despacho aduanal y soporte documental",
    "services.card.customs.p1": "Envíos transfronterizos sin retrasos. Nuestro equipo ayuda con documentos aduaneros, orientación sobre aranceles/impuestos, guías aéreas, requisitos de liberación y documentación para envíos internacionales, garantizando un flujo continuo de su mercancía.",
    "services.card.customs.p2": "<strong>Ideal para:</strong> envíos internacionales, requisitos de importación/exportación, cumplimiento transfronterizo.",

    "services.card.insurance.title": "Seguro de carga",
    "services.card.insurance.p1": "Ofrecemos opciones de seguro para todos los modos de transporte — aéreo, marítimo, ferroviario y terrestre — brindando tranquilidad mediante protección adicional para sus envíos.",
